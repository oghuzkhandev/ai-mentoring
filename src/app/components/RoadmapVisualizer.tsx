      ...
      <div className="border border-slate-700 rounded-2xl overflow-hidden shadow-2xl">
        <div className="relative w-full min-h-screen bg-slate-900 text-white px-8 py-12 flex flex-col items-center">
          ...
          >
            ...
            <p className="text-slate-300 mx-auto text-lg whitespace-pre-line text-center">
              {roadmap.overview || "Your career roadmap starts here."}
            </p>
            <p className="text-2xl font-bold mt-3 underline underline-offset-4 text-red-500">
              Please make fullscreen for more detailed RoadMap 🚀
            </p>
          </motion.div>
              ...
              <div className="min-h-screen w-full px-8 py-12 flex flex-col items-center">
                ...
                >
                  <div className="flex items-center gap-3 justify-center mb-6">
                    ...
                    <h1 className="text-3xl font-semibold text-blue-300 flex items-center">
                      Roadmap Overview
                    </h1>
                  </div>
                  <p className="text-red-300 mx-auto text-lg whitespace-pre-line">
                    {roadmap.overview || "Your career roadmap starts here."}
                  </p>
                </motion.div>
...
function StepCard({ step, index, completed, onToggle }: any) {
  ...
  return (
    <>
      <motion.div
        ...
        className={`relative bg-gradient-to-r from-gray-700 to-slate-500 border-2 rounded-2xl p-6 text-center shadow-md shadow-slate-100 cursor-pointer hover:scale-[1.2] border-orange-200 transition-all h-full flex flex-col`}
      >
        ...
        <h3 className="text-lg font-bold mb-3 line-clamp-2">{step.title}</h3>
      </motion.div>
      ...
      <AnimatePresence>
        {show && (
          <>
            ...
            />
            <motion.div
              className="fixed top-1/3 left-1/3 w-[90vw] max-w-2xl max-h-[80vh] overflow-y-auto -translate-x-1/2 -translate-y-1/2 bg-slate-900 p-8 rounded-2xl border-2 border-green-500 shadow-2xl z-[10001]"
